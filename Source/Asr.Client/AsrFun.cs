 ...
 * 文件名称:    AsrFun.cs
 * 
 * 描    述：   语音识别实现类，在本 dll 中作为代理功能类，配合 Asr.Server 实现语音识别分布式
 *              部署调用。
 *
 * 作    者:    王 喜 进
 *	
...
{
    /// <summary>
    /// /语音识别实现类，在本 dll 中作为代理功能类，配合 Asr.Server 实现语音识别分布式部署调用。
    /// </summary>
    internal class AsrFun : IAsr, ITranslate
    {
        /// <summary>
        /// 业务逻辑处理类
        /// </summary>
        ...
        /// 类实例
        /// </summary>
        private static AsrFun _instance = null;
        /// <summary>
        /// Asr 类锁，因识别和翻译都共用这个类
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        private AsrFun(string ip, int port)
        {
            _buzProcess = new BuzProcess(ip, port);
