...
namespace AsrServer
{
    ...
    internal class TCPServer : IDisposable
    {
        ...
        /// 客户端管理类
        /// </summary>
        private TCPClientManager _clientMgr = null;
        /// <summary>
        /// 是否开始，用于控制线程启停
        /// </summary>
        ...
        public TCPServer()
        {
            _clientMgr = new TCPClientManager();
        }
        ...
        private void TcpListen()
        {
            while (_isStart)
            {
                try
                {
                    ...
                    TCPClient client = new TCPClient(id, clientSocket);
                ...
                catch (Exception ex)
                {
                    ...
                    if (_isStart)
                    {
                        Utils.ShowInfo(this, "[Server] 套接字监听异常：" + ex.Message);
                    }
                }
            }
        }
