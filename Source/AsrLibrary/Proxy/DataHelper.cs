    ...
    internal class DataHelper
    {
        ...
        public bool Analyze0x0601(byte[] data, out string recgResult)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.WriteLog("解析数据 0x0601 异常" + ex.Message);
                return false;
            }
        }
        ...
        public List<Language> Analyze0x0602(byte[] data)
        {
            ...
            {
                Log.WriteLog("解析数据 0x0602 异常：" + ex.Message);
        ...
        public LanguageType Analyze0x0603(byte[] data)
        {
            ...
            {
                Log.WriteLog("解析数据 0x0603 异常：" + ex.Message);
        ...
        public bool Analyze0x0605(byte[] data, out string transResult)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.WriteLog("解析业务数据 0x0605 异常：" + ex.Message);
                return false;
            }
        }
