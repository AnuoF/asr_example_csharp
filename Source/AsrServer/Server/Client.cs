...
namespace AsrServer
{
    ...
    internal class Client : IDisposable
    {
        ...
        private void Deal0x0501(byte[] data)
        {
            ...
            string recgResult;
            ret = AsrFun.GetAsr().AudioRecog(audioData, languageType, out recgResult);
        ...
        {
            List<Language> languageList = AsrFun.GetAsr().GetLanguageList();
        ...
        private void Deal0x0503(byte[] data)
        {
            ...
            LanguageType type = AsrFun.GetAsr().Text2LanguageType(text);
        ...
        private void Deal0x0504(byte[] data)
        {
            ...
            LanguageType type = AsrFun.GetAsr().Name2LanguageType(name);
