...
namespace Test
{
    public partial class ucAsrClient : UserControl
    {
        ...
        {
            // 2) 获取可识别的语种列表
            _languageList = _client.IAsr.GetLanguageList();
            ShowLanguageList();
            panel2.Enabled = true;
        }
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            dlg.Filter = "pcm files (*.pcm)|*.pcm|wav files (*.wav)|*.wav|All files (*.*)|*.*";
        ...
        private void btnPlay_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cbPCM.Checked)
                {
                    ...
                    pcmFileName = mp3FileName;
                }

                SoundPlayer player = new SoundPlayer(pcmFileName);
                player.Play();
            }
            catch (Exception ex)
            {
        ...
        private void btnRecog_Click(object sender, EventArgs e)
        {
            ...
            ThreadPool.QueueUserWorkItem(o =>
            {
                ...
                {
                    // 3）语音识别
                    _client.AudioRecog(data, type, out result);
                }
                else
                {
                    ...
                    _client.AudioRecog(data, type, out result, waveFormat);
                }
        ...
        private LanguageType GetLanguageType(string text)
        {
            ...
            return _client.IAsr.Text2LanguageType(language.Text);
        }
